...
#     # Визначення Початку Тижня
#     start_of_week = today - timedelta(days=today.weekday())
#     str_start = start_of_week.strftime("%A")
#     print(f"start_of_week: {str_start}")
...
# users = [
#     {"name": "Terrible Monday", "birthday": datetime(2022, 12, 4)},
#     {"name": "Normal Tuesday", "birthday": datetime(2023, 12, 5)},
#     {"name": "Work Wednesday", "birthday": datetime(2023, 12, 6)},
#     {"name": "Unbearable Thursday", "birthday": datetime(2023, 12, 7)},
#     {"name": "Happy Friday", "birthday": datetime(2023, 12, 8)},
#     {"name": "Party Saturday", "birthday": datetime(2023, 12, 2)},
#     {"name": "Relax Sunday", "birthday": datetime(2023, 12, 3)},
#     {"name": "Alice NextMonday", "birthday": datetime(2023, 12, 11)},
#     {"name": "Alice NextTuesday", "birthday": datetime(2023, 12, 12)},
#     {"name": "Alice NextWednesday", "birthday": datetime(2023, 12, 13)},
#     {"name": "Alice NextThursday", "birthday": datetime(2023, 12, 14)},
# ]
